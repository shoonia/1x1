...
export const RandomColor: JSX.FC = () => {
  ...
  return (
    <button
      ...
      onclick={click}
    >
      <svg width="40" height="40" fill="currentcolor" viewBox="0 0 290 221">
        ...
        <circle r="14" transform="matrix(-.7 -.3 0 -1 188 152)" />
        <circle r="14" transform="matrix(-.7 -.3 0 -1 188 99)" />
        <circle r="14" transform="matrix(.7 .4 -.5 .4 133 156)" />
        <circle r="14" transform="matrix(.7 .4 -.5 .4 95 160)" />
        <circle r="14" transform="matrix(.7 .4 -.5 .4 154 186)" />
        <circle r="14" transform="matrix(.7 .4 -.5 .4 116 190)" />
        <circle r="14" transform="matrix(-.9 .3 -.1 1 115 97)" />
      </svg>
    </button>
  );
};
